...
serve(async (req) => {
  ...
  try {
    ...
    // =================== 4. DECIDE WIN/LOSS - PROBABILIDADE CORRIGIDA ===================
    
    // CORREÇÃO CRÍTICA: Usar win_probability_global para determinar vitórias
    // target_rtp é usado apenas para cálculos de valor de prêmios
    const winProbability = baseProbability; // Usar a probabilidade calculada anteriormente
