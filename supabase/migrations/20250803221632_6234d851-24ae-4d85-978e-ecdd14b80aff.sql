-- Corrigir questões de segurança RLS
-- Ativar RLS em tabelas que estão sem
...
-- Criar políticas para user_wallets
...
-- Criar políticas para wallet_transactions
...
-- Atualizar função process_scratch_card_game com search_path correto
