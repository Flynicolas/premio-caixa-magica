...
('R$ 500,00 PIX', 'dinheiro', 'legendary', 500.00, 'https://jhbafgzfphiizpuoqksj.supabase.co/storage/v1/object/public/head-images/money-500-real.png', 'digital', false, false, true, ARRAY['scratch_premium']),
...
('Notebook Gamer', 'eletronicos', 'legendary', 2500.00, 'https://jhbafgzfphiizpuoqksj.supabase.co/storage/v1/object/public/head-images/notebook-gamer.png', 'physical', true, true, true, ARRAY['scratch_premium']),
('Console PlayStation 5', 'eletronicos', 'legendary', 3200.00, 'https://jhbafgzfphiizpuoqksj.supabase.co/storage/v1/object/public/head-images/playstation5.png', 'physical', true, true, true, ARRAY['scratch_premium']);
