-- Atualizar ou inserir configurações visuais com imagens existentes do projeto

-- Função para fazer upsert nas configurações
DO $$
BEGIN
  -- Atualizar ou inserir Hero Slider
  INSERT INTO public.visual_configurations (section_type, section_name, config_data, is_active) 
  VALUES (
    'hero_slider', 
    'main_carousel',
    '{
  ...
  -- Atualizar banners existentes ou inserir novos
  INSERT INTO public.visual_configurations (section_type, section_name, config_data, is_active) 
  VALUES 
    (
      'banner',
    ...
    (
      ...
      '{
        "enabled": true,
        "imageUrlPC": "/lovable-uploads/a4e45f22-07f1-459a-a5c2-de5eabb4144a.png",
        "imageUrlMobile": "/lovable-uploads/a4e45f22-07f1-459a-a5c2-de5eabb4144a.png",
        "altText": "Banner secundário da home",
