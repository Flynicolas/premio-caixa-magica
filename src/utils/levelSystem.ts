...
export const calculateUserLevel = (totalSpent: number, prizesWon: number): UserLevel => {
  ...
  if (level >= 50) {
    ...
    benefits = ['Acesso VIP', 'Suporte prioritário', 'Baús exclusivos', 'Bônus de 50%', 'Cashback premium'];
    minSpent = 5000;
    minPrizes = 250;
  } else if (level >= 30) {
    title = 'Mestre';
    ...
    benefits = ['Suporte prioritário', 'Baús especiais', 'Bônus de 30%', 'Cashback melhorado'];
    minSpent = 3000;
    minPrizes = 150;
  } else if (level >= 20) {
    title = 'Experiente';
    ...
    icon = '⭐';
    color = 'text-blue-500';
    benefits = ['Baús aprimorados', 'Bônus de 20%', 'Recompensas extras'];
    minSpent = 2000;
    minPrizes = 100;
  } else if (level >= 10) {
    title = 'Veterano';
    ...
    benefits = ['Desconto em baús', 'Bônus de 10%', 'Recompensas semanais'];
    minSpent = 1000;
    minPrizes = 50;
  } else if (level >= 5) {
    title = 'Aventureiro';
    ...
    icon = '🚀';
    color = 'text-cyan-500';
    benefits = ['Acesso a mais baús', 'Bônus de experiência', 'Recompensas mensais'];
    minSpent = 500;
    minPrizes = 25;
  }
